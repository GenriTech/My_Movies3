...
public class NetworkUtils {
    public static final String API_KEY = "9e329f79509d7ba825924ed9d71e76c0";
    ...
    public static final String MIN_VOTE_COUNT_VALUE = "1500";

//    public static final String LANGUAGE_VALUE = "en-us";
//    public static final String LANGUAGE_VALUE = "uk-UA";
...
//                .appendQueryParameter(PARAMS_LANGUAGE, LANGUAGE_VALUE)
    ...
    // <------------- JSON for MOVIE ----------->
    public static JSONObject getJSONFromNetwork(int sort, int page, String lang) {
        JSONObject result = null;
        URL url = buildURL(sort, page, lang);
        //
        //Log.i("MyLog", "My URL in NetworkUtils: " + url);
        try {
            result = new JSONLoadTask().execute(url).get();
        } catch (ExecutionException e) {
            e.printStackTrace();
        ...
        //Log.i("MyLog", "JSON in NetworkUtils: " + result);
        return result;
    }
